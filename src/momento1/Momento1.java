...
public class Momento1 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2. Buscar Jugador por nÃºmero");
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    if (jugadores.size() == 0) {
                        System.out.println("**************************************************************\n");
                        System.out.println("El número de la camiseta ingresada no pertenece a ningun jugador");
                        System.out.println("**************************************************************\n");
                    } else {
                        ...
                        if (sw == 0) {
                            ...
                            System.out.println("NÃºmero de la camiseta: " + persona.getNumCamiseta());
                            System.out.println("Edad: " + persona.getEdad());
                            System.out.println("PosiciÃ³n: " + persona.getPosicion());
                    ...
                    if (jugadores.size() == 0) {
                        ...
                        for (int i = 0; i < jugadores.size(); i++) {
                            ...
                            if (camiseta == persona.getNumCamiseta()) {
                                ...
                                System.out.println("Ingrese nueva PosiciÃ³n: ");
                                ...
                                System.out.println("**************************************************************\n");
                                System.out.println("El número de la camisa ingresada no pertenece a ningUn jugador\n");
                                System.out.println("**************************************************************\n");
                            }
                        }
                    }
                ...
                case 4:
                    ...
                    if (jugadores.size() == 0) {
                        ...
                        System.out.println("Nombre Completo: " + persona.getNombre() + " " + persona.getApellido());
                        System.out.println("Numero de la camiseta: " + persona.getNumCamiseta());
                        System.out.println("Edad: " + persona.getEdad());
                        System.out.println("Posición: " + persona.getPosicion());
                        System.out.println("Equipo: " + persona.getEquipo() + "\n");
                        System.out.println("********************************\n");
